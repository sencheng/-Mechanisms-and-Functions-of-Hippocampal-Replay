...
class ReplayMonitor():
    ...
    def __init__(self, gui_parent, visual_output):
...
class OptimalityMonitor():
    ...
    def compute_optimal_utility(self, logs):
        '''
    ...
    def compute_action_probs_single(self, q_values, beta=0, action_mask=None):
        '''
    ...
    def compute_action_probs(self, Q, beta=0., action_mask=None):
        '''
