...
def computeReactivationMaps(euclidean_similarity=False, suffix=''):
    '''
...
def plot(reactivationMaps, euclidean_similarity=False, suffix=''):
    '''
    This functions plots the reactivation maps for the experiment's three environments.
    
    | **Args**
    | reactivationMaps:             The reactivation maps.
    '''
    ...
    # environment 1
    plt.subplot(1, 3, 1)
    plt.pcolor(np.flip(reactivationMaps[0], axis=0), cmap='hot', vmin=0, vmax=None)
    ...
    plt.pcolor(np.flip(reactivationMaps[1], axis=0), cmap='hot', vmin=0, vmax=None)
    plt.plot(x1, y1, x2, y2, color='c', linewidth=10, zorder=100)
    ...
    plt.pcolor(np.flip(reactivationMaps[2], axis=0), cmap='hot', vmin=0, vmax=None)
    plt.plot(x1, y1, x2, y2, color='c', linewidth=10, zorder=100)
    plt.plot(wall_1_x, wall_1_y, color='c', linewidth=5, zorder=100)
    plt.plot(wall_2_x, wall_2_y, color='c', linewidth=5, zorder=100)
    plt.plot(wall_3_x, wall_3_y, color='c', linewidth=5, zorder=100)
