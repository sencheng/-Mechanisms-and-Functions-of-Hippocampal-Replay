...
if __name__ == '__main__':
    ...
    t_maze = makeGridworld(10, 7, terminals=[0, 6], rewards=np.array([[6, 1]]), goals=[6], startingStates=[66], invalidTransitions=invalid_transitions)
    box = makeGridworld(10, 7, terminals=[0, 6], rewards=np.array([[6, 1]]), goals=[6], startingStates=[66], invalidTransitions=[])
