...
def count_points(replays: list, width: int, height: int, bin_size=1) -> np.ndarray:
    '''
...
def compute_randomness(R: np.ndarray, width: int, height: int) -> (float, float):
    '''
...
def compute_directions(replays: list, width: int, height: int, bin_size=20, dir_bin_size=90) -> np.ndarray:
    '''
...
def compute_reactivations(replays: list, width: int, height: int, view_width: int, view_height: int) -> np.ndarray:
    '''
...
def plot_starting_distribution(R: np.ndarray, bin_size=1, suffix=''):
    '''
    ...
    bin_size :                          The bin size.
    suffix :                            The suffix with which the file will be saved with.
...
def plot_directions(D: np.ndarray, suffix: str):
    '''
...
def plot_reactivations(R: np.ndarray, suffix=''):
    '''
    This function plots the diffusion of replays.
