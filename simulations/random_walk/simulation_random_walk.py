...
def single_run(gamma_SR: float, occupancies: dict, modes: list, decays: list, number_of_replays: int, batch_size: int):
    '''
    ...
    modes :                             The SFMA's replay modes that will be used.
