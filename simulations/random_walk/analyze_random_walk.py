...
def retrieve_replays(gammas: list, decays: list, height: int, width: int, occupancy: str, mode: str) -> dict:
    '''
    This function retrieves the replayed positions of the replays
    produced by the SFMA agent's memory module for different strength decay factors.
    ...
    occupancy :                         String indicating the predefined occupancy that was used.
    mode :                              The replay mode that was used.
    
    Returns
    ----------
    replays :                           A dictionary containing the replayed positions for different parameter combinations.
    '''
    results = dict()
    for gamma in gammas:
        results[gamma] = dict()
...
def trajectory_analysis(replays: list, intervals=[1, 2], regression_intervals=None) -> dict:
    '''
    ...
    Parameters
    ----------
    replays :                           The replays produced by the SFMA agent's memory module.
    ...
    Returns
    ----------
    regression_results :                A dictionary containing the regression results.
    '''
    results = dict()
...
def plot_relationship(sweep: dict, suffix=''):
    '''
    ...
    Parameters
    ----------
    sweep :                             The replays produced by the SFMA agent's memory module.
    suffix :                            Optional suffix that will be added to the file name.
...
def plot_replays(replays: list, map_size=21, suffix=''):
    '''
