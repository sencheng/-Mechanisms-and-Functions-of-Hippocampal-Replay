...
def recover_positions(replay: list, width: int, height: int) -> list:
    '''
    This function recovers the coordinates of replayed positions.
    ...
    Returns
    ----------
    positions :                         The replayed positions.
    '''
    positions = []
...
def single_run(gamma_SR: float, decay: float, number_of_replays: int, occupancies: dict, modes: list, betas: list):
    '''
    ...
    decay :                             The inhibition's decay factor.
    ...
    # initialize world            
    world = make_empty_field(100, 100)
